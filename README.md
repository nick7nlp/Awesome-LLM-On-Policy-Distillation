...
| 🟡 [Learning from the Self-future: On-policy Self-distillation for dLLMs](https://arxiv.org/abs/2606.18195) <br><sub>📐 LLaDA-8B-Instruct → Self; d-OPSD uses self-generated answer suffixes as privileged context with step-level supervision aligned to diffusion denoising</sub> | 2026 | [![Code](https://img.shields.io/badge/Code-GitHub-blue)](https://github.com/xingzhejun/d-opsd-code) |
...
| 🟡 [Cross-Domain Hybrid OPD for Generalizable Search Agents](https://arxiv.org/abs/2608.02101) <br><sub>📐 Hunyuan3-A21B Math Expert → Hunyuan3-A21B Search Agent; Hybrid RL + multi-domain on-policy distillation to mitigate alignment tax in search agents</sub> | 2026 |  |
...
| [Distill Where the Student Goes: Teacher-Regularized RL for English-Evidence Cross-Lingual RAG](https://arxiv.org/abs/2607.02966) | §4.3 | The method couples reward optimization with on-policy distillation via reverse-KL from teacher on student-visited prefixes, combining RL… |
...
| [HindSearch: Trajectory-Level Hindsight Critique for Search-Augmented Reinforcement Learning](https://arxiv.org/abs/2608.01597) | §4.3 | The method augments GRPO (RL) with an auxiliary OPD loss using a hint-conditioned teacher on student-generated rollouts, combining RL and… |
