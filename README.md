...
| [A Reduction of Imitation Learning and Structured Prediction to No-Regret Online Learning](https://arxiv.org/abs/1011.0686) | AISTATS 2011 | 2011 | DAgger — foundational on-policy IL |
...
|-------|---------|-------|------|----------------|
| [On-Policy Distillation of Language Models: Learning from Self-Generated Mistakes](https://arxiv.org/abs/2306.13649) | **GKD** | ICLR 2024 | 2024 | Foundational OPD: student generates, teacher scores |
| [MiniLLM: Knowledge Distillation of Large Language Models](https://arxiv.org/abs/2306.08543) | **MiniLLM** | ICLR 2024 | 2024 | Reverse KL + policy gradient for OPD |
| [DistiLLM: Towards Streamlined Distillation for Large Language Models](https://arxiv.org/abs/2402.03898) | **DistiLLM** | ICML 2024 | 2024 | Skewed KL + adaptive off-policy sampling |
| [DistiLLM-2: A Versatile Framework for On-Policy Knowledge Distillation](https://arxiv.org/abs/2412.15218) | **DistiLLM-2** | 2024 | 2024 | Generalized f-divergence OPD framework |
...
| [Fast On-Policy Distillation with Gradient-Level KD](https://arxiv.org/abs/2408.00118) | **Fast OPD** | 2024 | 2024 | Gradient-level supervision for efficiency |
...
| [Generalized On-Policy Distillation](https://arxiv.org/abs/2402.12842) | **G-OPD** | 2024 | 2024 | Generalized divergence family |
...
| [TSD-KD: Token-Selective Distillation](https://arxiv.org/abs/2402.13116) | **TSD-KD** | 2024 | 2024 | Select informative tokens for distillation |
...
| [DASD: Dual Adaptive Self-Distillation](https://arxiv.org/abs/2407.14679) | **DASD** | 2024 | 2024 | Self-distillation with dual adaptive mechanisms |
| [DDT: Distillation via Difference of Distributions](https://arxiv.org/abs/2505.16297) | **DDT/ToDi** | 2025 | 2025 | Sigmoid-weighted Forward+Reverse KL per token |
...
| Paper | Abbrev. | Venue | Date | Key Innovation |
|-------|---------|-------|------|----------------|
| [MiniLLM: Knowledge Distillation of Large Language Models](https://arxiv.org/abs/2306.08543) | **MiniLLM** | ICLR 2024 | 2024 | Policy gradient with teacher log-probs as reward |
| [Constrained On-Policy Distillation](https://arxiv.org/abs/2402.11890) | **Constrained** | 2024 | 2024 | KL-constrained sequence-level objective |
| [SCoRe: Multi-Turn Self-Correction for Reasoning](https://arxiv.org/abs/2509.14257) | **SCoRe** | 2025 | 2025 | Multi-turn correction with teacher feedback on earliest error |
...
| Paper | Abbrev. | Venue | Date | Key Innovation |
|-------|---------|-------|------|----------------|
| [AdaSwitch: Adaptive Switching for Token-Level Distillation](https://arxiv.org/abs/2510.07842) | **AdaSwitch** | 2025 | 2025 | Context-aware threshold for token-level teacher guidance |
| [PACED](https://arxiv.org/abs/2603.11178) | **PACED** | 2026 | 2026 | Minimax-robust curriculum + adaptive granularity |
| [Fast OPD](https://arxiv.org/abs/2408.00118) | **Fast OPD** | 2024 | 2024 | Gradient-level signal bridging token and sequence |
| [SuperCorrect: Teacher-Guided Hierarchical Thought Templates](https://arxiv.org/abs/2410.09008) | **SuperCorrect** | 2024 | 2024 | Step-level reasoning distillation + cross-model DPO |
...
| Paper | Abbrev. | Venue | Date | Key Innovation |
|-------|---------|-------|------|----------------|
| [Lion: Adversarial Distillation of Proprietary LLMs](https://arxiv.org/abs/2305.12870) | **Lion** | 2023 | 2023 | Teacher as preference annotator + curriculum designer |
| [GAD: Generative Adversarial Distillation](https://arxiv.org/abs/2511.10643) | **GAD** | 2025 | 2025 | Discriminator distinguishes student from API output |
| [OVD: On-Policy Verifiable Distillation](https://arxiv.org/abs/2603.24596) | **OVD** | 2026 | 2026 | Cross-modal OPD (text teacher → speech student) |
| [LUFFY: Merging Exploration and Exploitation in OPD](https://arxiv.org/abs/2504.14945) | **LUFFY** | 2025 | 2025 | Dynamic coefficient balancing exploration and imitation |
...
| Paper | Abbrev. | Venue | Date | Key Innovation |
|-------|---------|-------|------|----------------|
| [Self-Play Fine-Tuning Converts Weak to Strong Models](https://arxiv.org/abs/2401.01335) | **SPIN** | ICML 2024 | 2024 | Two-player game: distinguish self vs human |
| [On-Policy Self-Distillation for LLMs (OPSD)](https://arxiv.org/abs/2601.18734) | **OPSD** | 2026 | 2026 | Privileged info (ground-truth) as teacher signal |
| [OPSDC: On-Policy Self-Distillation for Reasoning Compression](https://arxiv.org/abs/2603.05433) | **OPSDC** | 2026 | 2026 | "Be concise" self-distillation, 57-59% token reduction |
| [GATES: Gated Self-Distillation without Ground-Truth](https://arxiv.org/abs/2602.20574) | **GATES** | 2026 | 2026 | Consensus-based gating for self-distillation |
| [SDPO: Self-Distillation Policy Optimization](https://arxiv.org/abs/2601.20802) | **SDPO** | 2026 | 2026 | Rich textual feedback → dense token-level self-distillation |
| [OEL: Online Experiential Learning](https://arxiv.org/abs/2603.16856) | **OEL** | 2026 | 2026 | Continuous post-deployment on-policy context distillation |
| [SDFT: Self-Distillation for Continual Learning](https://arxiv.org/abs/2601.19897) | **SDFT** | 2026 | 2026 | On-policy self-distillation reduces catastrophic forgetting |
| [HDPO: Hybrid Distillation Policy Optimization](https://arxiv.org/abs/2503.00386) | **HDPO** | 2026 | 2026 | Privileged distillation for "cliff prompts" |
| [Privileged Information Distillation](https://arxiv.org/abs/2602.04942) | **PI-Distill** | 2026 | 2026 | Training-time privileged info for hard RL settings |
| [OPCD: On-Policy Context Distillation](https://arxiv.org/abs/2402.12842) | **OPCD** | 2024 | 2024 | Internalize experiential knowledge via context distillation |
...
| Paper | Abbrev. | Venue | Date | Key Innovation |
|-------|---------|-------|------|----------------|
| [DeepSeek-R1: Incentivizing Reasoning in LLMs via RL](https://arxiv.org/abs/2501.12948) | **DeepSeek-R1** | 2025 | 2025 | Off-policy reasoning distillation at scale |
| [RLKD: Reinforcement Learning via KD](https://arxiv.org/abs/2505.16142) | **RLKD** | 2025 | 2025 | RL objective with KD regularization |
| [AlignDistil: Align-then-Distill](https://arxiv.org/abs/2503.02832) | **AlignDistil** | 2025 | 2025 | Preference optimization + OPD |
| [KDRL: Joint KD and RL](https://arxiv.org/abs/2506.02208) | **KDRL** | 2025 | 2025 | Jointly optimize KD+RL to prevent forgetting |
| [RLAD: Reinforcement Learning with Auxiliary Distillation](https://arxiv.org/abs/2512.23097) | **RLAD** | 2025 | 2025 | Unified KD+RL framework |
| [KEPO: Knowledge-Enhanced Policy Optimization](https://arxiv.org/abs/2602.12125) | **KEPO** | 2026 | 2026 | Student exceeds teacher via reward-guided exploration |
| [VOLD: Vision-Language On-Policy Distillation](https://arxiv.org/abs/2510.23497) | **VOLD** | 2025 | 2025 | Text teacher → VLM student with SFT cold-start |
...
|-------|-------|------|-------------|
| [DeepSeek-R1](https://arxiv.org/abs/2501.12948) | 2025 | 2025 | 7B student achieves 92.8% on MATH-500 from 671B teacher |
| [Qwen3 Technical Report](https://arxiv.org/abs/2505.09388) | 2025 | 2025 | Multi-teacher OPD at scale; thinking mode distillation |
| [RL Post-Training Retains More Capabilities](https://arxiv.org/abs/2510.18874) | 2025 | 2025 | RL retains more pre-training knowledge than SFT |
| [Distillation Scaling Laws](https://arxiv.org/abs/2502.08606) | ICML 2025 | 2025 | Off-policy distillation scaling (on-policy still open!) |
| [Precision-Recall Trade-off in Distillation](https://arxiv.org/abs/2505.13111) | 2025 | 2025 | Entropy controls precision vs recall in KD |
