...
| [Agentic Reinforcement Learning with Observation-Calibrated Self-Distillation](https://arxiv.org/abs/2608.04788) | §5.3.2 | OCSD contrasts Full vs Observation-Ablated replay views of the same policy to derive a calibrated log-prob residual that modulates… |
