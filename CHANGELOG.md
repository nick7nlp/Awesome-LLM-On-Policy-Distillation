...
- Loss-taxonomy figures now cover **152 OPD-method papers** (excluding 13 analysis-of-OPD papers and 6 reference-only entries from the count, since they don't propose a single OPD loss).
